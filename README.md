...
**[Village Compute](https://github.com/teacurran?tab=repositories&q=village)** — A suite of production applications built almost entirely through AI-assisted development. I'm using multi-agent workflows to generate, review, and refine code, with SonarQube static analysis to measure and improve AI-generated code quality.
